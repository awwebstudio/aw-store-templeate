...
margin:0;
color:white;">
📦 Stok <span style="color:#facc15;">Hampir Habis</span>
</h1>
...
margin-top:12px;
margin-bottom:0;">
Daftar produk dengan stok 5 atau kurang.
</p>
...
@php
$products = \App\Models\Product::where('stok','<=',5)->get();
@endphp
...
@empty
<tr>
    <td colspan="3" style="padding:25px;text-align:center;color:#94a3b8;">
